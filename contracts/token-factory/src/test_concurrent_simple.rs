...
struct CanonicalStore {
    creator_tokens: Vec<(u32, u32)>,
    token_info: Vec<TokenSnapshot>,
    token_count: u32,
}
...
impl CanonicalStore {
    ...
    fn get_creator_tokens(&self, creator_id: u32) -> Vec<u32> {
...
fn test_pagination_subset_correctness_under_interleaving() {
    ...
    for page_size in &page_sizes {
        ...
        while offset < all_tokens.len() {
            ...
            let _page_tokens: Vec<u32> = all_tokens[offset..end].to_vec();
